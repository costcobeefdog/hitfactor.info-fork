...
export const safeNumSort =
  (field, { allowNegatives } = {}) =>
  (a, b) => {
    ...
    return (
      Math.max(allowNegatives ? Number.NEGATIVE_INFINITY : 0, bValue || 0) -
      Math.max(allowNegatives ? Number.NEGATIVE_INFINITY : 0, aValue || 0)
    );
  };
